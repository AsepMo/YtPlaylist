...
public class PlaylistStarter extends AppCompatActivity {
    ...
    private Runnable mRunner = new Runnable()
    {
        ...
        public void run()
        {
            YoutubeTasksActivity.start(PlaylistStarter.this);
            PlaylistStarter.this.finish(); 
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_playlist_starter);
