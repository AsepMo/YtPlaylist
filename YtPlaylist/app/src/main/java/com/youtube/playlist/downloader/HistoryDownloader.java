...
public class HistoryDownloader extends Fragment
{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
		...
		return inflater.inflate(R.layout.history_loader_layout, container, false);
	}
	...
	public void onViewCreated(View view, Bundle savedInstanceState)
	{
        ...
        HistoryLoader historyLoader = new HistoryLoader(getActivity(), listView, new String[]{VideoUtils.MP4});
	...
	{
        HistoryLoader historyLoaderTwo = new HistoryLoader(getActivity(), listView, new String[]{VideoUtils.MP4});
					...
					public View getView(final int position, View convertView, ViewGroup parent)
					{
						...
						convertView.setOnClickListener(new View.OnClickListener() {
								...
								public void onClick(View v)
								{
									...
									Intent mVideo = new Intent(getActivity(), VideoPlayerActivity.class);
									mVideo.putExtra(VideoPlayerActivity.TAG_URL, video.videoThumb);
