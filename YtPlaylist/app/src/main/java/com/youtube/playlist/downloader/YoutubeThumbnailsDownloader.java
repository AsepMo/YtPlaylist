...
public class YoutubeThumbnailsDownloader extends AppCompatActivity
{
	...
	{
		Intent mThumbnail = new Intent(c, YoutubeThumbnailsDownloader.class);
		mThumbnail.putExtra(Intent.EXTRA_TEXT, url);
	    c.startActivity(mThumbnail);
	}
    ...
    protected void onCreate(Bundle savedInstanceState)
	{
        ...
        setContentView(R.layout.activity_download_thumbnails);
		...
		String urlFromIntent = getIntent().getStringExtra(Intent.EXTRA_TEXT);
		showProgressDialog();
    ...
    private void downloadThumbnail(String thumbnailURLstring, final String videoID)
	{
        try
		{
            ...
            File ordnerpfad = new File(YoutubeFolder.ZFOLDER_IMG, "Thumbnails");
		...
		{
            e.printStackTrace();
            File thumbnailcheckfile = new File(YoutubeFolder.ZFOLDER_IMG, "Thumbnails" + "/thumbnail_" + videoID + ".jpg");
	...
	{
        getMenuInflater().inflate(R.menu.menu_thumbnails_downloader, menu);
        publicmenu = menu;
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
	{
		...
		{
            startActivity(new Intent(this, YoutubeRecentThumbnails.class));
            return true;
        }
